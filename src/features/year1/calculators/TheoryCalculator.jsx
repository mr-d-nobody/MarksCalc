...
const TheoryCalculator = () => {
  ...
  const internalFields = [
    ...
    { label: 'Assignment', key: 'assignment', max: 12, weight: 12 },
    { label: 'Surprise Test / Quiz', key: 'surpriseTest', max: 12, weight: 6 },
    { label: 'Case Study / Course Project', key: 'courseProject', max: 20, weight: 10 },
  ];

  const resultData = [
    { label: 'Internal Marks (out of 50)', value: `${results.internalTotal || results.totalWeighted || '--'}` },
    { label: 'External Marks (out of 50)', value: `${results.externalScaled || '--'}` },
      ...
      <div className="lg:col-span-2 glass-panel p-8 rounded-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
          <InputField
            ...
            max={60}
            value={inputs['externalTheory'] ?? ''}
            onChange={(val) => handleInputChange('externalTheory', val)}
          />
        </div>
        <button
