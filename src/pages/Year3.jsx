  ...
  return (
    <div className="py-8">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-white mb-4 text-glow">3rd Year Calculator</h1>
        <p className="text-[var(--color-text-main)] max-w-2xl mx-auto">
          Calculate your marks for 3rd Year Hybrid, Theory, Practical, or Aptitude subjects.
        </p>
      </div>
